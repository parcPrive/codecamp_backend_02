...
export class ProductService {
  ...
  async findAll() {
    return await this.productRepository.find({
      relations: ['productSaleslocation', 'productCategory'], //여기안에들어간 데이터 까지 가져온다.
    });
  }
  ...
  async create({ createProductInput }) {
    ...
    return await this.productRepository.save({
      ...
      productCategoryId: { id: productCategoryId }, //카테고리 추가 (result 통째로 넣기 vs id만 넣기)
    });
  }
